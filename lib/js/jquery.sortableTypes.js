(function( $ ) {
	...
	$._sortableTypes.helper = {
		...
		init: function(element, options) {
			...
			this.element.append(this.settings.templates.basic);
		...
		_addCreateTypeDialog: function() {
			...
			mainSelect.children(':first').remove();
		...
		_redrawSelects: function() {
			...
			var typeSelector = this.element.children('.selectors').children('.typeSelectors'),
				mainHidden = false, lastMainValue = '', lastMainKey = '';
			if (typeSelector.children('.mainTypeSelector').children().is(':visible') === false)
			{
				...
				lastMainKey   = typeSelector.children('.mainTypeSelector').children().children(':selected').data('key');
			}
			...
			if (mainHidden)
			{
				typeSelector.children('.mainTypeSelector').children().hide();
